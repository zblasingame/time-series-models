"""A class for creating flexible feed forward neural networks.
...
class NeuralNet:
    ...
    Args:
        sizes (list of int): List describing the number of units in each layer.
        activations (list of function): List of TensorFlow activation
            functions, must be one less element than the number of elements in
            the parameter sizes.
    """
